...
public class StaticButtonPaginatedMask extends ButtonPaginatedMask {
   ...
   */
  public StaticButtonPaginatedMask(@NotNull String name, @NotNull List<@NotNull Integer> slots, @NotNull Button... buttons) {
    super(name, slots);
   ...
   * @param buttons the buttons
   */
  public StaticButtonPaginatedMask(@NotNull String name, @NotNull List<@NotNull Integer> slots, @NotNull List<@NotNull Button> buttons) {
    super(name, slots);
    this.addButtons(buttons);
  }
